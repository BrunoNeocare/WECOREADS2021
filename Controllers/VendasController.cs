...
namespace WebApplication1.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idVenda,produtoSelecionado")] Vendas vendas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idVenda,produtoSelecionado")] Vendas vendas)
        {
